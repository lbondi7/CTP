...
{
	localVertices[0] = glm::vec4(v1, 1.0f);
	localVertices[1] = glm::vec4(v2, 1.0f);
	localVertices[2] = glm::vec4(v3, 1.0f);
    ...
    normal = glm::vec4(glm::normalize(glm::cross(glm::vec3(edges[0]), glm::vec3(edges[1]))), 1.0f);
