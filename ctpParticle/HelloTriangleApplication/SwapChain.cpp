...
{
	instance = _instance;
	physicalDevice = Locator::GetDevices()->GetPhysicalDevice();
...
void SwapChain::Create(GLFWwindow* window) {
	...
	VkExtent2D _extent = ChooseSwapExtent(swapChainSupport.capabilities, window);
	...
	QueueFamilyIndices indices = Locator::GetDevices()->FindQueueFamilies(surface);
