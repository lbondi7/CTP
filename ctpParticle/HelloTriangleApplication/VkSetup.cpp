...
namespace VkSetup
{
	...
	void createInstance(VkInstance& instance) {
		if (enableValidationLayers && !VkSetupHelper::checkValidationLayerSupport()) {
		...
		auto extensions = VkSetupHelper::getRequiredExtensions();
		...
		if (enableValidationLayers) {
			...
			VkSetupHelper::populateDebugMessengerCreateInfo(debugCreateInfo);
	...
	void setupDebugMessenger(const VkInstance& instance, VkDebugUtilsMessengerEXT& debugMessenger) {
		...
		VkSetupHelper::populateDebugMessengerCreateInfo(createInfo);

		if (VkSetupHelper::CreateDebugUtilsMessengerEXT(instance, &createInfo, nullptr, &debugMessenger) != VK_SUCCESS) {
	...
	void pickPhysicalDevice(VkInstance& instance, VkPhysicalDevice& physicalDevice, const VkSurfaceKHR& surface) {
		...
		for (const auto& device : devices) {
			if (VkSetupHelper::isDeviceSuitable(device, surface)) {
